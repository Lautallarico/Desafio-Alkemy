...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Bienvenido al sistema de libreria alkemy");
        int opcion;
        do {
            System.out.println();
        ...
        System.out.println("Gracias por utilizar el sistema de biblioteca Alkemy");
